        ...
        <div id="chatroom" class="bg-black card mt-5 border-0 shadow-lg rounded-lg overflow-hidden">
            <div class="p-4">
				...
				<p class="lead float-start pt-3 ps-2">
					Enter either the track title, the artist or a command.
				</p>
            </div>
            <div class="p-4">
                <div id="messages" class="overflow-y-scroll overflow-x-hidden text-light fs-5">
                </div>
                <div class="mt-4">
                    <input 
					type="text" 
					...
					placeholder="Type the track title or artist..." 
					autofocus>
                </div>
            </div>
        </div>
